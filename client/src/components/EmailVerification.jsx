...
function EmailVerification() {
  const handleVerifyUser = useStore((state) => state.handleVerifyUser);
  const VerificationCode = useStore((state) => state.VerificationCode);
  const handleVerifyCode = useStore((state) => state.handleVerifyCode);
  ...
  return (
    <div className="bottom_bar min-w-[40vw] min-h-[48vh] bg-[rgb(24,24,24)] rounded-t-lg flex-col border-b-[2px] border-[rgb(40,40,40)]">
      ...
      <section>
        ...
        <div className="flex justify-between items-center mb-8 px-40 mt-9">
          <label className="font-Spline_Mono" htmlFor="VerificationCode">
            Verification Code :
          </label>
          <input
        ...
        <div className="flex justify-center items-center">
          <button
            onClick={() => handleVerifyUser(VerificationCode)}
